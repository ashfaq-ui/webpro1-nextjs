    ...
    return(
      ...
      <div className="intro-video-area">
        <video className="intro-video" autoPlay muted loop>
          <source src="/iPhone-page/iphone-video/iphone.mp4" type="video/mp4" />
      ...
      <main>
                ...
                <div className="content-area1" id="content-area1">
                    <div id="h1-background">
                        <h1 style={{color: "rgb(255, 255, 255)"}}>iPhone 16 Series</h1>
                    </div>
                    ...
                    <div className="slider-container">
                        <div className="sub-1-1" id="sub-1-1">
                            ...
                            <a href="#" style={{color: "rgb(255, 255, 255)"}}>Click here to more Details</a>
                        </div>
                ...
                <div className="content-area2" id="content-area2">

                    <h1 style={{color: "rgb(255, 255, 255)"}}>iPhone 15 Series</h1>
                ...
                <div className="content-area3" id="content-area3">

                    <h1 style={{color: "rgb(255, 255, 255)"}}>iPhone 14 Series</h1>
                ...
                <div className="content-area4" id="content-area4">

                    <h1 style={{color: "rgb(255, 255, 255)"}}>iPhone 13 Series</h1>
                ...
                <div className="content-area5" id="content-area5">

                    <h1 style={{color: "rgb(255, 255, 255)"}}>iPhone 12 Series</h1>
                ...
                <div className="content-area6" id="content-area6">

                    <h1 style={{color: "rgb(255, 255, 255)"}}>iPhone 11 Series</h1>
                ...
                <div className="content-area7" id="content-area7">

                    <h1 style={{color: "rgb(255, 255, 255)"}}>iPhone 10 Series</h1>
